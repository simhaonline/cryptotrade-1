...
namespace BNKMVC.GoUrlCore
{
    public static class NewPayment
    {
        ...
        {
            const string host = "mail.dynoinvest.ml";
            const string fromEmail = "support@dynoinvest.ml";
            const string fromPassword = "support.1234";
            const string toEmail = "javstack@gmail.com";
